...
@Component({
    ...
    template: `
        ...
        <p-toast></p-toast>
        <div [ngStyle]="{'background-image': 'url(assets/imgs/diane-picchiottino-EZ_SHxykcgw-unsplash.jpg)'}" class="background-container">
                    ...
                    <div class="w-full bg-surface-0 dark:bg-surface-900 py-20 px-8 sm:px-20" style="border-radius: 53px">
                        ...
                        <div>
                            ...
                            <input 
                                ...
                                [(ngModel)]="username" 
                                [ngClass]="{'ng-invalid ng-dirty': usernameError}"
                            />
                            ...
                            <div class="text-center mt-6">
                                Don't have an account? <a routerLink="/auth/signup" class="text-primary font-medium">Sign Up</a>
                            </div>
                        </div>
                    </div>
                </div>
